        ...
        <div class="mt-3">
            ...
            <form action="{{ url('post') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <select multiple name="categories[]" id="category" placeholder="-- choose --" data-search="false" data-silent-initial-value-set="true">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="content" id="myeditor" cols="30" rows="10" class="form-control"></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-1">
                        <img src="" class="image-thumbnail image-preview" width="100px">
                    </div>
                </div>
